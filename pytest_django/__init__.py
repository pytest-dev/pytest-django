...
def pytest_addoption(parser):
    ...
    parser.addoption('--copy_live_db', help='Copies the database rather than creating and migrating a new one.', action='store_true', default=False)
    parser.addoption('--database', help='Copies the database rather than creating and migrating a new one.', action='store', dest='database_name')
